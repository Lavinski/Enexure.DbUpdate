...
{
	/// <summary>
	/// Builds an <c>UpgradeEngine</c> by accepting a list of callbacks to execute. For custom configuration, you should 
	...
	public class UpgradeEngineBuilder
	{
		...
		public UpgradeEngineBuilder Configure(Action<UpgradeConfiguration> configuration)
		{
